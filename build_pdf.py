...
OPPORTUNITY_ROWS = [
    ...
    ["Warehouse / WMS (new)",
     ...
     "+ order batching",
     "logistics-flow-studio (WarehouseTwin v3.34), logistics-digital-twin (engine)",
     "-48.6% pick travel; ABC ~21% > random; ISO 22400 KPIs; per-order routing (20 ops, 8 archetypes); 174/174 self-test + 66 harnesses + 76 Python tests; "
...
JOB1_ROWS = [
    ...
    ["Rapid prototyping", "agent-flow-studio, agentic-automation-lab, logistics-flow-studio",
     ...
     "factory/plant simulator (PWA, v3.34; 66 harnesses + 76 Python tests + 174/174 self-test), "
...
JOB2_ROWS = [
    ...
    ["Warehouse / intralogistics + factory / process industry",
     ...
     "import + floor-plan underlay; -48.6% pick travel; ABC ~21% > random; per-order routing (20 ops, 8 archetypes); 174/174 "
     "self-test + 66 harnesses + 76 Python tests; engine slotting -44.2% (golden-zone 25% -> 100%), "
