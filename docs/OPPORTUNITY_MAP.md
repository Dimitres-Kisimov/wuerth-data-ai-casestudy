...
- **Honesty note.** The German-standards panel (ASR A1.8, DIN 15185, EN 15512, EPAL/DIN EN 13698, VDI 2510/3564, DGUV) is framed **"aligned to, NOT a certification"**. With imported data, the UI badges honestly switch between "Data: synthetic demo" and "Data: yours", and what *stays* a model assumption (pallet counts, picker speed, the order stream if none is imported) is stated in the app itself.
