...
| 9 | Warehouse / WMS / intralogistics | WMS twin + plant simulator (ISO 22400 KPIs) + slotting + DES + packing | logistics-flow-studio (WarehouseTwin v1.0), logistics-digital-twin | −48.6% pick travel (optimizer); ABC ~21% > random; 22 scenarios; 23 harnesses; slotting −44.2%; DES −76.1% cycle / −66.5% travel; fill 2.0% → 30.2% |
