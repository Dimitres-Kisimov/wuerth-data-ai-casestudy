...
| 3 | Inventory / replenishment | Newsvendor + forecasting + safety stock | revops-optimizer, distributor-intelligence-platform, ml-models-lab, supply-network-opt | MASE 0.376; MASE 0.987 / RMSSE 0.948 (beats naive + Holt-Winters); safety stock −65.7% / −80.1% |
...
| 9 | Warehouse / intralogistics | Digital twin + slotting + DES + packing | logistics-flow-studio, logistics-digital-twin | −49.8% pick travel (optimizer); ABC ~26% > random; slotting −44.2%; DES −76.1% cycle / −66.5% travel; fill 2.0% → 30.2% |
